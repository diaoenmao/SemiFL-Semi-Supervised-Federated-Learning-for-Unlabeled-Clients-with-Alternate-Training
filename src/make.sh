...
python make.py --mode ssfl --run train --num_experiments 4 --round 12 --split_round 3
python make.py --mode ssfl --run test --num_experiments 4 --round 12 --split_round 3

python make.py --mode frgd --run train --num_experiments 4 --round 12 --split_round 3
python make.py --mode frgd --run test --num_experiments 4 --round 12 --split_round 3

python make.py --mode fmatch --run train --num_experiments 4 --round 12 --split_round 3
python make.py --mode fmatch --run test --num_experiments 4 --round 12 --split_round 3
...
python make.py --mode alternate --run train --num_experiments 4 --round 12 --split_round 4
python make.py --mode alternate --run test --num_experiments 4 --round 12 --split_round 4